...
Детальніше див. [http://php.net/manual/en/function.preg-replace.php опис PHP-функції preg_replace()].',
	...
	'masseditregex-max-preview-diffs' => 'Попередній перегляд було обмежено {{PLURAL:$1|1=першим $1  збігом|першими $1 збігами}}.',
...
$messages['zh-hans'] = array(
	...
	'masseditregextext' => '请输入一个或多个正则表达式以供匹配（每行一个），并输入一个或多个表达式以替换匹配的内容。
首个匹配表达式若成功，将使用首个替换表达式替换，以此类推。
参看[http://php.net/manual/en/function.preg-replace.php PHP的preg_replace()函数]了解细节。',
	...
	'masseditregex-num-changes' => '$1：$2个更改',
	'masseditregex-page-not-exists' => '$1 不存在',
	'masseditregex-num-articles-changed' => '已编辑$1个页面',
	...
	'masseditregex-hint-toappend' => '追加一些文本到页面底端 - 例如为页面添加分类',
